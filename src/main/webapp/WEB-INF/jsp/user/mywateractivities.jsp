                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                        ...
                        <div class="d-flex align-items-center mb-3 pb-1">
                            ...
                            <span class="h1 fw-bold mb-0"
                                  style="color: rgba(39,58,171,0.9); display: block; margin:0 auto;">My Water Activities </span>
                        </div>
                                ...
                                <div class="col-md-4" style="display: block; margin: 0 auto;">
                                    ...
                                    <div class="card" style="height: 100%;">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title"
                                                style="text-
align: center"> ${waterActivity.waterActivity}  </h5>
                                            <p class="card-text">${waterActivity.description}</p>

                                            <form action="/user/removewateractivity" method="post">
                                                <button type="submit">
                                                    <input type="hidden" name="waterActivityId" id="waterActivityId"
                                                           value="${waterActivity.id}">
                                                    Remove
                                                </button>
                                            </form>
                                        </div>
