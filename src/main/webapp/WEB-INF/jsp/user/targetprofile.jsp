                    ...
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row"
                            ...
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                <img src="${form.profileImg}" class="img-fluid img-thumbnail mt-4 mb-2"
                                     name="profileImg"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <p class="mb-0"><a href="http://localhost:8000/meetuppost/userposts/${form.id}"
                                               class="text-muted">MeetupPosts</a> | <a
                                    href="http://localhost:8000/user/wateractivity/${form.id}" class="text-muted">View
                                WaterSports</a></p>
                        </div>
